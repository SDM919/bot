...
BOT_TOKEN = getenv("7523604200:AAGktsewlJABW4x_slKDO1Dz8SaZvURGiwc")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002388409705"))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/SDM919/bot")
